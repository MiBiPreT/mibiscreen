...
class TestActivity:
    ...
    def test_activity_plot_01(self):
        ...
        """
        fig, ax = activity_plot(self.data_01)
    ...
    def test_activity_plot_02(self):
        ...
        """
        fig, ax = activity_plot(self.data_02)
    ...
    def test_activity_plot_03(self):
        ...
        """
        fig, ax = activity_plot(self.data_03)
    ...
    def test_activity_plot_04(self):
        ...
        """
        fig, ax = activity_plot(self.data_04)
    ...
    def test_activity_plot_06(self):
        """Testing routine activity_plot().
        ...
        with pytest.raises(ValueError,
           match="Provided arrays/lists/series of data must have the same length."):
            activity_plot([self.conc,self.meta,self.traffic[:-1]])

    def test_activity_plot_07(self):
        """Testing routine activity_plot().
        ...
        with pytest.raises(ValueError,
           match="Data needs to be DataFrame or list of at least three lists/np.arrays/pd.series."):
            activity_plot(self.conc_pd)

    def test_activity_plot_08(self):
        """Testing routine activity_plot().

        Testing Error message that not sufficient data for a plot.
        """
        with pytest.raises(ValueError,
           match="Too little data for activity_plot plot. At least two values per quantity required."):
            activity_plot([[1],[2],[3]])

    def test_activity_plot_09(self,capsys):
        """Testing routine activity_plot().
        ...
        activity_plot(self.data_01,save_fig = save_fig)
